...
namespace Homework_5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string inputFileimage = Console.ReadLine(); //"F:\\Users\\jeenz\\Desktop\\Text HW5\\test_input_image.txt";
            double[,] imageDataInputFile = ReadImageDataFromFile(inputFileimage);

            Console.Write("Address of the Convolution Kernel data file. : ");
            string DataFileConvolutionKernel = Console.ReadLine(); //"F:\\Users\\jeenz\\Desktop\\Text HW5\\test_convolution.txt";
            ...
            string DataFileOutput = Console.ReadLine(); //"F:\\Users\\jeenz\\Desktop\\Text HW5\\test_output_image.txt";
